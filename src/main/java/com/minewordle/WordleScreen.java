...
public class WordleScreen extends Screen {
    ...
    private void playWinSound(int g){var s=g<=4?SoundEvents.ENTITY_PLAYER_LEVELUP:SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP;MinecraftClient.getInstance().getSoundManager().play(PositionedSoundInstance.master(s,1.0f));}
